...
export default function AuthButton() {
  ...
  if (status === "loading") {
    return <div className="animate-pulse bg-gray-100 h-10 w-24 rounded-full"></div>;
  }
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-5 py-2.5 text-sm font-medium bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 rounded-full transition-all shadow-sm"
    >
